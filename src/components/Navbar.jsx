    ...
    <div className="w-full h-[13vh]  flex items-center p-2 justify-around uppercase text-xs font-bold">
        ...
        <div className="flex items-center justify-around h-full w-full md:w-[40%] ">
          ...
          document.getElementById('my_modal_1').showModal()
            ...
            <Dialog></Dialog>
            <a  href="https://drive.google.com/file/d/1ISag7wq9a3xFMkV6YrDiRk3NdX0QKJt_/view?usp=sharing" className="leading-tight tracking-tighter bg-gradient-to-t from-[#cfc09f] via-[#95771e] to-[#ffae0b] text-transparent bg-clip-text" >My resume</a>
        </div>
    </div>
  )
}
